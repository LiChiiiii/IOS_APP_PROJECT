...
class UserController: ObservableObject {
    ...
    func GetUserPhoto(){
        networkingService.GET_userPhoto(endpoint: "/UserPhoto/\(NowUserID!)"){ [self] (result) in
            switch result {
            case nil:
...
//
//    func GetUserInfo(){
//        networkingService.GetUserInfo(endpoint: "/users/\(NowUserName)"){ (result) in
//            switch result {
//            case .success(let res):
//                print("get all userInfo")
//                self.UserInfo = res
//
